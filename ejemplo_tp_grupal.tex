...
\begin{proc}{redistribucionDeLosFrutos}{\In recursos : \TLista{\float }, \In cooperan : \TLista{\bool}}{\TLista{\float }}
	...
	\asegura{\paraTodo[unalinea]{i}{\ent} {cooperan[i] = True \implicaLuego res[i] = fondoComun(recursos, cooperan)/|recursos|} }
	\asegura{\paraTodo[unalinea]{i}{\ent} {cooperan[i] = False \implicaLuego res[i] = fondoComun(recursos,cooperan)/|recursos| + recursos[i]} }
